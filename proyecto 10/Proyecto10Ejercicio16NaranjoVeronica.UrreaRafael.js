...
/**
 * Calcula la sumatoria de los factoriales desde 0 hasta el número dado utilizando recursividad.
 ...
 */
function sumatoriaFactoriales(num) {
  if (num === 0) {
    return factorial(num);
  } else {
    return factorial(num) + sumatoriaFactoriales(num - 1);
  }
}
