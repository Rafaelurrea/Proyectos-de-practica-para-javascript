...
const factorial=(x) => {
  ...
  const calculateHyperbolicCosine = () =>{
    ...
    // Calcular la serie de Taylor para aproximar cosh(x)
    for (let i = 1; i < t; i++) {
      // Calcular el término de la serie utilizando la fórmula de la serie de Taylor para cosh(x)
