...
const calculateSine = ()=> {
  ...
  let x, s = 0; // Variables para almacenar el valor de 'x' y el resultado de la serie de Taylor
  ...
  // Calcular la serie de Taylor para aproximar sen(x)
  s = x; // El primer término de la serie es x

  for (let i = 1; i < t; i++) {
    // Calcular el término de la serie utilizando la fórmula de la serie de Taylor para sen(x)
