...
const imprimir = (fila, contador, final, valorLetras, dato) => {
  ...
  for (let i = fila; i <= 7; i++) {
    ...
    for (let k = 0; k < letras; k++) {
      process.stdout.write(String.fromCharCode(82 - dato));
    }
    ...
    dato += 2; // Incrementar el valor de dato para las letras correspondientes
  }
}
//se llama la funcion
imprimir(1, 1, 0, 13, 2);
